...
- `balccon-2k26-hardware/` — KiCad project for the physical pin/badge PCB (schematic, board)
  - `pcb-svg/` — SVG layers exported from KiCad (`copper.svg`, `mask-front.svg`, `mask-back.svg`, `silkscreen-front.svg`, `esge-cuts.svg`, `hex.svg`, `log.svg`)
